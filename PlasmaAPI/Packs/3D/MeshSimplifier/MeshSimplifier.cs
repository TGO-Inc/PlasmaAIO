...
namespace Plasma.Packs.MeshUtil
{
    ...
    public sealed class MeshSimplifier
    {
        ...
        /// </summary>
        internal SimplificationOptions SimplificationOptions
        {
        ...
        private BlendShape[] GetAllBlendShapes()
        {
            if (blendShapes == null)
                return null;
        ...
        private BlendShape GetBlendShape(int blendShapeIndex)
        {
        ...
        private void AddBlendShape(BlendShape blendShape)
        {
        ...
        private void AddBlendShapes(BlendShape[] blendShapes)
        {
            if (blendShapes == null)
        ...
        internal static void ValidateOptions(SimplificationOptions options)
        {
