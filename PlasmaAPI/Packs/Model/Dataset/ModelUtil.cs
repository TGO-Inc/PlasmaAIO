        ...
        public static void SetupMaterialWithBlendMode(Material mtl, MtlBlendMode mode)
        {
            switch (mode)
            {
                case MtlBlendMode.OPAQUE:
                    ...
                    mtl.SetInt("_SrcBlend", (int)Rendering.BlendMode.One);
                    mtl.SetInt("_DstBlend", (int)Rendering.BlendMode.Zero);
                ...
                case MtlBlendMode.FADE:
                    ...
                    mtl.SetInt("_SrcBlend", (int)Rendering.BlendMode.SrcAlpha);
                    mtl.SetInt("_DstBlend", (int)Rendering.BlendMode.OneMinusSrcAlpha);
